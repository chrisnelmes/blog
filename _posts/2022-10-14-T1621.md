...
# Implementation
- Install Network Policy Server on a new or existing server with Active Directory Environment  
...
- Clone https://github.com/frontporch/Radius.NET and open in Visual Studio. Upon opening the project you may be prompted to upgrade the project to .net framework 4.8. In my enviornment I had accepted this option and the project build succesfully.
